...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "IQAudioRecorderController/IQAudioRecorderController/Resources/scissor.png"
  install_resource "IQAudioRecorderController/IQAudioRecorderController/Resources/scissor@2x.png"
  install_resource "IQAudioRecorderController/IQAudioRecorderController/Resources/scissor@3x.png"
